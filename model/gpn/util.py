...
def _apply_mask(y_hat: Union[dict, Tensor, ], mask: Tensor) -> Union[dict, Tensor, ]:
...
def apply_mask(data: Data, y_hat: Union[dict, Tensor, ], split: str,
               return_target: bool = True) -> Union[Union[dict, Tensor, ], Tuple[Union[dict, Tensor, ], Tensor]]:
