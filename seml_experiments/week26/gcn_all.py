...
def build():
    ...
    for dataset, jobs in (('cora_full', 6),  ('amazon_photo', 2), ('citeseer', 6), ('pubmed', 2), ('coauthor_cs', 2)):
...
def build_experiments(cfg):
    for ood_type, ood_type_short in (('left-out-classes', 'loc'), ('perturbations', 'per')):
        ...
        subcfg['fixed']['run.name'] = 'dataset:{1}-setting:{0}-ood_type:' + ood_type_short
        ...
        subcfg['fixed']['run.name'] = 'sn:dataset:{1}-setting:{0}-ood_type:' + ood_type_short
        subcfg['fixed']['data.ood_type'] = ood_type
        subcfg['fixed']['model.use_spectral_norm'] = True
        ...
        subcfg['fixed']['run.name'] = 'reco:dataset:{1}-setting:{0}-ood_type:' + ood_type_short
        subcfg['fixed']['data.ood_type'] = ood_type
